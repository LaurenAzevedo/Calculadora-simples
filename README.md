...
O **Calculadora** permite ao usuário realizar contas, como: soma, subtração, divisão e multiplicação e mostrar o resultado 

## 🔧 Funcionalidades

- [x] Entrada de dados (valor 1 e valor 2);
- [x] Disponibilidade de escolha da operação matemática;
...
1. Clone este repositório:
    ...
    ```bash
    git clone https://github.com/LaurenAzevedo/Calculadora-simples.git
...
│   ├── src
│   │   ├── main
│   │   │   ├── java/br/ulbra/Calculadora simples
│   │   │  
...
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/LaurenAzevedo/Calculadora-simples/blob/main/LICENSE)
